<?php 
	...
	{
		echo "
			<div style='width: 350px; background-color: #ff3741; z-index: 100; border-radius: 10px; border: 1px solid black; margin-top: 10px; position: absolute; right: 20px; top: 0; font-size: 9pt; font-family: Arial; align-self: flex-start;'>
				<!-- Header -->
