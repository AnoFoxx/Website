...
<div class="naptar-container">
	...
	<div class="naptar-header">
		...
		<script type="text/javascript">
			document.getElementById("elozo_honap").addEventListener("click", () => {
				document.cookie = <?php echo "'ev=$elozo_ev;'" ?>;
				document.cookie = <?php echo "'ho=$elozo_honap;'" ?>;
				window.location.reload();
			});
			document.getElementById("kov_honap").addEventListener("click", () => {
				document.cookie = <?php echo "'ev=$kov_ev;'" ?>;
				document.cookie = <?php echo "'ho=$kov_honap;'" ?>;
				window.location.reload();
			});
		</script>
	</div>
